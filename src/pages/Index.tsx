...
const Index = () => {
  ...
  return (
    <>
      <SEOHead 
        title="24 Hour Towing Service Nandyal - Emergency Roadside Assistance Andhra Pradesh | Hussain Towing Services"
        description="24/7 emergency towing service in Nandyal, Andhra Pradesh. Professional car breakdown service AP wide. Fast response, 300km radius coverage. Call +91 98765 43210 now!"
        keywords="24 hour towing service Nandyal, emergency roadside assistance Andhra Pradesh, car breakdown service AP, towing service near me, vehicle recovery Nandyal"
        canonical="https://hussaintowing.com/"
        ogType="website"
